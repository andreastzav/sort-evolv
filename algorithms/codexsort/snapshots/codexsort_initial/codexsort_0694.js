...
function mergeStable(array, scratch, start, middle, end, compare) {
  ...
  const mergeTrimMinSpan = array.length < 20000 ? 1536 : array.length < 100000 ? 736 : MERGE_TRIM_MIN_SPAN;
...
function tryStableBucketSort(array, compare) {
  ...
  for (let i = 0; i < array.length; i += 1) {
    ...
    if (lastIndex >= 0 && compare(value, reps[lastIndex]) === 0) {
      buckets[lastIndex].push(value);
      continue;
    }
