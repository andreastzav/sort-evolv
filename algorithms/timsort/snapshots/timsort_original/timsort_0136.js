const FastTimSort = (() => {
  ...
  function copyFromBuffer(destArray, destStart, srcArray, srcStart, count) {
    ...
    if (count <= 8) {
      switch (count) {
        case 8:
          destArray[destStart + 7] = srcArray[srcStart + 7];
        // falls through
        case 7:
          destArray[destStart + 6] = srcArray[srcStart + 6];
        // falls through
        case 6:
          destArray[destStart + 5] = srcArray[srcStart + 5];
        // falls through
        case 5:
          destArray[destStart + 4] = srcArray[srcStart + 4];
        // falls through
        case 4:
